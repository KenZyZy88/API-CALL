...
def summary_table():
    ...
    for x in range(0, len(ingest_table)): 
        ...
        if os.path.exists('C:/Users/K3nXz/Desktop/sph/leaderboard_summary.txt'):
            summary_table.to_csv('C:/Users/K3nXz/Desktop/sph/leaderboard_summary.txt', sep='|', index=False,header=True)
        else:
            summary_table.to_csv('C:/Users/K3nXz/Desktop/sph/leaderboard_summary.txt', sep='|', index=False,header=True)
...
def breakdown_table():
    ...
    for x in range(0, len(ingest_table)):
        ...
        if os.path.exists('C:/Users/K3nXz/Desktop/sph/leaderboard_breakdown.txt'):
            breakdown_table.to_csv('C:/Users/K3nXz/Desktop/sph/leaderboard_breakdown.txt', sep='|', index=False,header=True)
        else:
            breakdown_table.to_csv('C:/Users/K3nXz/Desktop/sph/leaderboard_breakdown.txt', sep='|', index=False,header=True)
...
def subscriberData_table():
    ...
    for x in range(0, len(ingest_table)):
        ...
        if os.path.exists('C:/Users/K3nXz/Desktop/sph/leaderboard_subscriberData.txt'):
            subscriberData_table.to_csv('C:/Users/K3nXz/Desktop/sph/leaderboard_subscriberData.txt', sep='|', index=False,header=True)
        else:
            subscriberData_table.to_csv('C:/Users/K3nXz/Desktop/sph/leaderboard_subscriberData.txt', sep='|', index=False,header=True)
